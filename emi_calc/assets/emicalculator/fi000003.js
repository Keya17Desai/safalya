(function() {
    ...
    function ua(a, b, c, d) {
        var e = N.lang,
            f = b === -1 ? ((a || 0).toString().split(".")[1] || "").length : isNaN(b = Q(b)) ? 2 : b,
    ...
    function Cb(a, b, c, d) {
        ...
        if (r(b)) {
            ...
            b = 1;
            h = i[Ya]();
            for (var d = i.getTime(), m = i[Xa](), l = i[Qa](), p = g ? 0 : (864E5 + i.getTimezoneOffset() * 6E4) % 864E5; d < c;) e.push(d), j === E[xa] ? d = Za(h + b * k, 0) : j === E[Pa] ? d = Za(h, m + b * k) : !g && (j === E[oa] || j === E[Wa]) ? d = Za(h, m, l + b * k * (j === E[oa] ? 1 : 7)) : d += j * k, b++;
            e.push(d);
            n(ob(e, function(a) {
        ...
        O.HighchartsAdapter = O.HighchartsAdapter || a && {
            init: function(b) {
                ...
                a.fn.highcharts = function() {
                    ...
                    c = b[0];
                    if (c !== y) c.chart = c.chart || {}, c.chart.renderTo = this[0], new Highcharts[a](c, b[1]), d = this;
        ...
        htmlUpdateTransform: function() {
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    ...
                    k = {};
                    if (G !== this.cTT) {
                        if (r(j)) a.isSVG ? (B = Fa ? "-ms-transform" : db ? "-webkit-transform" : eb ? "MozTransform" : Lb ? "-o-transform" : "", k[B] = k.transform = "rotate(" + j + "deg)") : (p = j * bb, s = Y(p), p = ca(p), k.filter = j ? ["progid:DXImageTransform.Microsoft.Matrix(M11=", s, ", M12=", -p, ", M21=", p, ", M22=", s, ", sizingMethod='auto expand')"].join("") : S), L(b, k);
    ...
    Ja.prototype = {
        ...
        render: function(a, b, c) {
            ...
            if (i && !isNaN(H)) i.xy = P = this.getLabelPosition(H, P, i, g, k, u, a, t), this.isFirst && !o(e.showFirstLabel, 1) || this.isLast && !o(e.showLastLabel, 1) ? v = !1 : !x && g && k.overflow === "justify" && !this.handleOverflow(a, P) && (v = !1), t && a % t && (v = !1), v && !isNaN(P.y) ? (P.opacity = c, i[this.isNew ? "attr" : "animate"](P), this.isNew = !1) : i.attr("y", -9999)
        },
        destroy: function() {
            Ha(this, this.axis)
        }
    ...
    ab.prototype = {
        ...
        getLogTickPositions: function(a, b, c, d) {
            ...
            if (a >= 0.5) a = t(a), g = this.getLinearTickPositions(a, b, c);
                ...
                for (var f = T(b), h, i, j, k, m, e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !m; f++) {
                    i = e.length;
                    for (h = 0; h < i && !m; h++) j = ka(da(f) * e[h]), j > b && (!d || k <= c) && g.push(k), k > c && (m = !0), k = j
        ...
        adjustForMinRange: function() {
            var a = this.options,
                ...
                f, g, h, i, j;
            if (this.isXAxis && this.minRange === y && !this.isLog) r(a.min) || r(a.max) ? this.minRange = null : (n(this.series, function(a) {
                i = a.xData;
    ...
    rb.prototype = {
        ...
        onContainerClick: function(a) {
            ...
            if (!b.cancelClick) c && this.inClass(a.target, "highcharts-tracker") ? (g = this.chartPosition, h = c.plotX, i = c.plotY, v(c, {
                ...
                point: c
            })), b.hoverPoint && c.firePointEvent("click", a)) : (v(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && D(b, "click", a))
        },
    ...
    sb.prototype = {
        init: function(a, b) {
            var c = this,
                ...
                f = b.itemMarginTop || 0;
            this.options = b;
            if (b.enabled) c.baseline = u(d.fontSize) + 3 + f, c.itemStyle = d, c.itemHiddenStyle = x(d, b.itemHiddenStyle), c.itemMarginTop = f, c.padding = e, c.initialItemX = e, c.initialItemY = e - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.lastLineHeight = 0, c.render(), J(c.chart, "endResize", function() {
        ...
        renderItem: function(a) {
            ...
            if (!n && (a.legendGroup = d.g("legend-item").attr({
                    zIndex: 1
                }).add(b.scrollGroup), t.drawLegendSymbol(b, a), a.legendItem = n = d.text(e.labelFormat ? wa(e.labelFormat, a) : e.labelFormatter.call(a), m ? g + h : -h, b.baseline, u).css(x(a.visible ? i : j)).attr({
                    align: m ? "left" : "right",
                    zIndex: 2
    ...
    F = ea(R, {
        ...
        drawPoints: function() {
            ...
            n(a.points, function(e) {
                var f = e.plotY,
                    g = e.graphic;
                if (f !== y && !isNaN(f) && e.y !== null) d = e.shapeArgs, g ? (Ta(g), g.animate(x(d))) : e.graphic = c[e.shapeType](d).attr(e.pointAttr[e.selected ? "select" : ""]).add(a.group).shadow(b.shadow, null, b.stacking && !b.borderRadius);
        ...
        drawDataLabels: function() {
            ...
            if (e.enabled || a._hasPointLabels) {
                ...
                if (pa(D) === 0 || this.verifyDataLabelOverflow(D)) this.placeDataLabels(), r && g && n(this.points, function(b) {
                    i = b.connector;
                    u = b.labelPos;
                    if ((v = b.dataLabel) && v._pos) E = v._attr.visibility, A = v.connX, z = v.connY, j = k ? ["M", A + (u[6] === "left" ? 5 : -5), z, "C", A, z, 2 * u[2] - u[4], 2 * u[3] - u[5], u[2], u[3], "L", u[4], u[5]] : ["M", A + (u[6] === "left" ? 5 : -5), z, "L", u[2], u[3], "L", u[4], u[5]], i ? (i.animate({
                        d: j
...
Highcharts.c = {
    ...
    title: {
        style: {
            color: "#444444",
            font: "bold 14px Open Sans, Arial, Verdana, sans-serif"
        }
    },
    subtitle: {
        style: {
    ...
    xAxis: {
        ...
        labels: {
            style: {
                color: "#000",
                font: "11px Open Sans, Arial, Verdana, sans-serif"
            }
        },
        title: {
            style: {
...
var c, e, f, g, h, k, l, m, n, p, q, r, s, t = [],
    u = [],
    v = [],
    x = [],
    A = [],
...
jQuery(document).ready(function() {
    ...
    jQuery("ul.loanproduct-nav li").click(function() {
        "active" != jQuery(this).attr("class") && (jQuery(this).addClass("active").siblings().removeClass("active"), m = jQuery(this).attr("id"), "home-loan" == m ? F("Home Loan Amount", 1E7, 5E4, 25E5, 20, 10.5, 30, 0.5, 240) : "personal-loan" == m ? F("Personal Loan Amount", 15E5, 1E4, 35E4, 25, 17.5, 5, 0.25, 36) : "car-loan" == m && F("Car Loan Amount", 2E6, 1E4, 4E5, 20, 12.5, 7, 0.25, 60), G());
        return !1
    });
    ...
    jQuery("#startmonthyear").datepicker({
        ...
        changeYear: !0,
        showButtonPanel: !0,
        onChangeMonthYear: function(a, d) {
            h = new Date(a, d - 1, 1);
            jQuery(this).datepicker("setDate", new Date(a, d - 1, 1))
        },
        onClose: function() {
            jQuery(this).datepicker("getDate").toDateString() != h.toDateString() && G()
        },
        beforeShow: function() {
            0 < (selDate = jQuery(this).val()).length && (s = selDate.substring(selDate.length - 4, selDate.length), r = jQuery.inArray(selDate.substring(0, selDate.length - 5), jQuery(this).datepicker("option", "monthNames")), jQuery(this).datepicker("option", "defaultDate", new Date(s, r, 1)), jQuery(this).datepicker("setDate", new Date(s, r, 1)))
        }
    });
    ...
    jQuery("#loanterm").blur(function() {
        "loanyears" == jQuery("#emicalcalulatorform input[name='loantenure']:checked").val() ? jQuery("#loanterm").val(Math.round(100 * (Math.round(12 * jQuery("#loanterm").val().replace(/[^\d\.]/g, "")) / 12)) / 100) : jQuery("#loanterm").val(jQuery("#loanterm").val().replace(/[^\d\.]/g, ""))
    });
    jQuery("#emicalcalulatorform input[name='loantenure']").change(function() {
        "loanyears" == jQuery("#emicalcalulatorform input[name='loantenure']:checked").val() ? jQuery("#loanterm").val(Math.round(100 * (jQuery("#loanterm").val().replace(/[^\d\.]/g, "") / 12)) / 100) : jQuery("#loanterm").val(Math.round(12 * jQuery("#loanterm").val().replace(/[^\d\.]/g, "")));
        I()
    });
    jQuery("#emicalcalulatorform input[name='emischeme']").change(function() {
        G()
    });
    F("Home Loan Amount", 1E7, 5E4, 25E5, 20, 10.5, 30, 0.5, 240);
    G()
});

function F(a, d, w, b, y, z, J, K, H) {
    ...
    jQuery("#loaninterest").val(1E3 * z / 1E3);
    "loanyears" == jQuery("#emicalcalulatorform input[name='loantenure']:checked").val() ? jQuery("#loanterm").val(H / 12) : jQuery("#loanterm").val(H);
    n = jQuery("#loanamountslider").slider({
        range: "min",
    ...
    p = jQuery("#loaninterestslider").slider({
        range: "min",
    ...
    "loanmonths" == jQuery("#emicalcalulatorform input[name='loantenure']:checked").val() && (a = parseInt(jQuery("#loanterm").val()) / 12);
    q = jQuery("#loantermslider").slider({
        range: "min",
        value: a,
        min: 0,
        max: J,
    ...
    jQuery("#loanamount").change(function() {
        n.slider("value", this.value.replace(/[^\d\.]/g, ""));
        G()
    });
    jQuery("#loaninterest").change(function() {
        p.slider("value", this.value);
        G()
    });
    jQuery("#loanterm").change(function() {
        "loanyears" == jQuery("#emicalcalulatorform input[name='loantenure']:checked").val() ? q.slider("value", this.value) : q.slider("value", this.value / 12);
        G()
    });
    I();
    "car-loan" == m ? jQuery(".toggle-hidden").removeClass("toggle-hidden").addClass("toggle-visible") : jQuery(".toggle-visible").removeClass("toggle-visible").addClass("toggle-hidden");
    "home-loan" == m ? (jQuery("#emiadvancearrears").removeClass("show_element").addClass("hide_element"), jQuery("#emicalcalulatorinnerform").css("height", "340px")) : "personal-loan" == m ? (jQuery("#emiadvancearrears").removeClass("show_element").addClass("hide_element"), jQuery("#emicalcalulatorinnerform").css("height", "340px")) : "car-loan" == m && (jQuery("#emiadvancearrears").removeClass("hide_element").addClass("show_element"), jQuery("#emicalcalulatorinnerform").css("height", "395px"))
}

function I() {
    "home-loan" == m ? (jQuery("#loanamountsteps").html('<span class="tick" style="left: 0%;">|<br/><span class="marker">0</span></span><span class="tick" style="left: 25%;">|<br/><span class="marker">25L</span></span><span class="tick" style="left: 50%;">|<br/><span class="marker">50L</span></span><span class="tick" style="left: 75%;">|<br/><span class="marker">75L</span></span><span class="tick" style="left: 100%;">|<br/><span class="marker">100L</span></span>'), jQuery("#loanintereststeps").html('<span class="tick" style="left: 0%;">|<br/><span class="marker">5</span></span><span class="tick" style="left: 16.67%;">|<br/><span class="marker">7.5</span></span><span class="tick" style="left: 33.34%;">|<br/><span class="marker">10</span></span><span class="tick" style="left: 50%;">|<br/><span class="marker">12.5</span></span><span class="tick" style="left: 66.67%;">|<br/><span class="marker">15</span></span><span class="tick" style="left: 83.34%;">|<br/><span class="marker">17.5</span></span><span class="tick" style="left: 100%;">|<br/><span class="marker">20</span></span>'), "loanyears" == jQuery("#emicalcalulatorform input[name='loantenure']:checked").val() ? jQuery("#loantermsteps").html('<span class="tick" style="left: 0%;">|<br/><span class="marker">0</span></span><span class="tick" style="left: 16.67%;">|<br/><span class="marker">5</span></span><span class="tick" style="left: 33.33%;">|<br/><span class="marker">10</span></span><span class="tick" style="left: 50%;">|<br/><span class="marker">15</span></span><span class="tick" style="left: 66.67%;">|<br/><span class="marker">20</span></span><span class="tick" style="left: 83.33%;">|<br/><span class="marker">25</span></span><span class="tick" style="left: 100%;">|<br/><span class="marker">30</span></span>') : jQuery("#loantermsteps").html('<span class="tick" style="left: 0%;">|<br/><span class="marker">0</span></span><span class="tick" style="left: 16.67%;">|<br/><span class="marker">60</span></span><span class="tick" style="left: 33.33%;">|<br/><span class="marker">120</span></span><span class="tick" style="left: 50%;">|<br/><span class="marker">180</span></span><span class="tick" style="left: 66.67%;">|<br/><span class="marker">240</span></span><span class="tick" style="left: 83.33%;">|<br/><span class="marker">300</span></span><span class="tick" style="left: 100%;">|<br/><span class="marker">360</span></span>')) : "personal-loan" == m ? (jQuery("#loanamountsteps").html('<span class="tick" style="left: 0%;">|<br/><span class="marker">0</span></span><span class="tick" style="left: 16.67%;">|<br/><span class="marker">2.5L</span></span><span class="tick" style="left: 33.34%;">|<br/><span class="marker">5L</span></span><span class="tick" style="left: 50%;">|<br/><span class="marker">7.5L</span></span><span class="tick" style="left: 66.67%;">|<br/><span class="marker">10L</span></span><span class="tick" style="left: 83.34%;">|<br/><span class="marker">12.5L</span></span><span class="tick" style="left: 100%;">|<br/><span class="marker">15L</span></span>'), jQuery("#loanintereststeps").html('<span class="tick" style="left: 0%;">|<br/><span class="marker">5</span></span><span class="tick" style="left: 12.5%;">|<br/><span class="marker">7.5</span></span><span class="tick" style="left: 25%;">|<br/><span class="marker">10</span></span><span class="tick" style="left: 37.5%;">|<br/><span class="marker">12.5</span></span><span class="tick" style="left: 50%;">|<br/><span class="marker">15</span></span><span class="tick" style="left: 62.5%;">|<br/><span class="marker">17.5</span></span><span class="tick" style="left: 75%;">|<br/><span class="marker">20</span></span><span class="tick" style="left: 87.5%;">|<br/><span class="marker">22.5</span></span><span class="tick" style="left: 100%;">|<br/><span class="marker">25</span></span>'), "loanyears" == jQuery("#emicalcalulatorform input[name='loantenure']:checked").val() ? jQuery("#loantermsteps").html('<span class="tick" style="left: 0%;">|<br/><span class="marker">0</span></span><span class="tick" style="left: 20%;">|<br/><span class="marker">1</span></span><span class="tick" style="left: 40%;">|<br/><span class="marker">2</span></span><span class="tick" style="left: 60%;">|<br/><span class="marker">3</span></span><span class="tick" style="left: 80%;">|<br/><span class="marker">4</span></span><span class="tick" style="left: 100%;">|<br/><span class="marker">5</span>') : jQuery("#loantermsteps").html('<span class="tick" style="left: 0%;">|<br/><span class="marker">0</span></span><span class="tick" style="left: 20%;">|<br/><span class="marker">12</span></span><span class="tick" style="left: 40%;">|<br/><span class="marker">24</span></span><span class="tick" style="left: 60%;">|<br/><span class="marker">36</span></span><span class="tick" style="left: 80%;">|<br/><span class="marker">48</span></span><span class="tick" style="left: 100%;">|<br/><span class="marker">60</span>')) : "car-loan" == m && (jQuery("#loanamountsteps").html('<span class="tick" style="left: 0%;">|<br/><span class="marker">0</span></span><span class="tick" style="left: 25%;">|<br/><span class="marker">5L</span></span><span class="tick" style="left: 50%;">|<br/><span class="marker">10L</span></span><span class="tick" style="left: 75%;">|<br/><span class="marker">15L</span></span><span class="tick" style="left: 100%;">|<br/><span class="marker">20L</span></span>'), jQuery("#loanintereststeps").html('<span class="tick" style="left: 0%;">|<br/><span class="marker">5</span></span><span class="tick" style="left: 16.67%;">|<br/><span class="marker">7.5</span></span><span class="tick" style="left: 33.34%;">|<br/><span class="marker">10</span></span><span class="tick" style="left: 50%;">|<br/><span class="marker">12.5</span></span><span class="tick" style="left: 66.67%;">|<br/><span class="marker">15</span></span><span class="tick" style="left: 83.34%;">|<br/><span class="marker">17.5</span></span><span class="tick" style="left: 100%;">|<br/><span class="marker">20</span></span>'), "loanyears" == jQuery("#emicalcalulatorform input[name='loantenure']:checked").val() ? jQuery("#loantermsteps").html('<span class="tick" style="left: 0%;">|<br/><span class="marker">0</span></span><span class="tick" style="left: 14.29%;">|<br/><span class="marker">1</span></span><span class="tick" style="left: 28.57%;">|<br/><span class="marker">2</span></span><span class="tick" style="left: 42.86%;">|<br/><span class="marker">3</span></span><span class="tick" style="left: 57.14%;">|<br/><span class="marker">4</span></span><span class="tick" style="left: 71.43%;">|<br/><span class="marker">5</span></span><span class="tick" style="left: 85.71%;">|<br/><span class="marker">6</span></span><span class="tick" style="left: 100%;">|<br/><span class="marker">7</span></span>') : jQuery("#loantermsteps").html('<span class="tick" style="left: 0%;">|<br/><span class="marker">0</span></span><span class="tick" style="left: 14.29%;">|<br/><span class="marker">12</span></span><span class="tick" style="left: 28.57%;">|<br/><span class="marker">24</span></span><span class="tick" style="left: 42.86%;">|<br/><span class="marker">36</span></span><span class="tick" style="left: 57.14%;">|<br/><span class="marker">48</span></span><span class="tick" style="left: 71.43%;">|<br/><span class="marker">60</span></span><span class="tick" style="left: 85.71%;">|<br/><span class="marker">72</span></span><span class="tick" style="left: 100%;">|<br/><span class="marker">84</span></span>'))
}
...
function L() {
    ...
    e = Math.abs(jQuery("#loaninterest").val() / 12 / 100);
    ...
    0 == e && (jQuery("#loaninterest").val(5), e = 0.004166666666666667, p.slider("value", 5));
    0 == f && ("loanyears" == jQuery("#emicalcalulatorform input[name='loantenure']:checked").val() ? jQuery("#loanterm").val(1) : jQuery("#loanterm").val(12), q.slider("value", 1), f = 12);
    k = 0;
    "emiadvance" == jQuery("#emicalcalulatorform input[name='emischeme']:checked").val() && (k = 1);
    g = "car-loan" == m && 1 == k ? c * e * (Math.pow(1 + e, f - 1) / (Math.pow(1 + e, f) - 1)) : c * e * (Math.pow(1 + e, f) / (Math.pow(1 + e, f) - 1));
    ...
    C = [];
    D = [];
    A[0] = new Date(h.getTime());
    "car-loan" == m && 1 == k ? (C[0] = 0, B[0] = g) : (C[0] = c * e, B[0] = g - C[0]);
    D[0] = c - B[0];
    var a = A[0].getFullYear(),
        d = 0;
    t[d++] = a;
    u[a] = B[0];
    v[a] = C[0];
    x[a] = D[0];
    for (i = 1; i < f; i++) A[i] = new Date(A[i - 1].getTime()), A[i].setMonth(A[i].getMonth() + 1), C[i] = D[i - 1] * e, B[i] = g - C[i], D[i] = D[i - 1] - B[i], A[i].getFullYear() != a && (a = A[i].getFullYear(), t[d++] = a, u[a] = 0, v[a] = 0, x[a] = 0), u[a] += B[i], v[a] += C[i], x[a] = D[i];
    D[f - 1] = 0;
    x[a] = 0;
    M();
    N();
...
function N() {
    for (var a = [], d = [], w = [], b = 0, b = 0, y = t.length; b < y; b++) {
        var z = t[b];
        a[b] = z;
        d[b] = u[z];
        w[b] = v[z]
    ...
    new Highcharts.Chart({
        ...
        yAxis: {
            ...
            stackLabels: {
                ...
                style: {
                    fontWeight: "bold",
                    color: Highcharts.theme && Highcharts.theme.k || "gray"
                }
            },
            labels: {
                formatter: function() {
        ...
        legend: {
            ...
            y: 20,
            floating: !0,
            backgroundColor: Highcharts.theme && Highcharts.theme.j || "white",
            shadow: !1
        },
        tooltip: {
            formatter: function() {
                return "<b>Year : " + this.x + "</b><br/>" + this.series.name + " : \Rs. " + Globalize.format(this.y, "n", "en-IN") + "<br/>Total : \Rs. " + Globalize.format(this.point.stackTotal, "n", "en-IN")
            }
        },
        plotOptions: {
            column: {
...
function O() {
    l = '<table><tr><th id="yearheader">Year</th><th id="principalheader">Principal</th><th id="interestheader">Interest</th><th id="totalheader">Principal + Interest</th><th id="balanceheader">Balance</th></tr>';
    for (var a = 0, d = 0, w = t.length; d < w; d++) {
        var b = t[d];
        l += '<tr class="yearlypaymentdetails"><td id="year' + b + '" class="paymentyear toggle">' + b + '</td><td class="currency">\<img src="images/Rupee_Symbol.png" alt=""> ' + Globalize.format(u[b], "n", "en-IN") + '</td><td class="currency">\<img src="images/Rupee_Symbol.png" alt=""> ' + Globalize.format(v[b], "n", "en-IN") + '</td><td class="currency">\<img src="images/Rupee_Symbol.png" alt=""> ' +
            Globalize.format(u[b] + v[b], "n", "en-IN") + '</td><td class="currency">\<img src="images/Rupee_Symbol.png" alt=""> ' + Globalize.format(x[b], "n", "en-IN") + "</td></tr>";
        l += '<tr id="monthyear' + b + '" class="monthlypaymentdetails"><td class="monthyearwrapper" colspan="5"><div id="monthlypaymentcontainer"><table>';
        for (var y = A.length; a < y && A[a].getFullYear() == b;) l += '<tr><td class="paymentmonthyear">' + E[A[a].getMonth()] + '</td><td class="currency">\<img src="images/Rupee_Symbol.png" alt=""> ' + Globalize.format(B[a], "n", "en-IN") + '</td><td class="currency">\<img src="images/Rupee_Symbol.png" alt=""> ' + Globalize.format(C[a], "n", "en-IN") + '</td><td class="currency">\<img src="images/Rupee_Symbol.png" alt=""> ' + Globalize.format(B[a] + C[a], "n", "en-IN") + '</td><td class="currency">\<img src="images/Rupee_Symbol.png" alt=""> ' + Globalize.format(D[a++], "n", "en-IN") + "</td></tr>";
        l += "</table></div></td></tr>"
    }
    l += "</table>";
    jQuery("#emipaymenttable").html(l);
